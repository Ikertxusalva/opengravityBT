...
STATUS: LABORATORIO — Proxy de funding vía RSI no genera edge robusto; ninguna PASS
en multi-test de 25 activos. Necesita datos reales de funding para ser viable.
"""
import sys
